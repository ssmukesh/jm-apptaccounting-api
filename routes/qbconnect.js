...
router.get('/requestToken', function (req, res, next) {
    ...
    var redirecturl = QuickBooks.AUTHORIZATION_URL +
        ...
        '&redirect_uri=' + encodeURIComponent('http://localhost:3000/api/callback') +  //Make sure this path matches entry in application dashboard
...
router.get('/callback', function (req, res, next) {
    ...
    var postBody = {
        ...
        form: {
            ...
            code: req.query.code,
            redirect_uri: 'http://localhost:3000/api/callback'  //Make sure this path matches entry in application dashboard
        }
    };
